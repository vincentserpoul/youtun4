...
use mp3youtube_core::{RustyYtdlDownloader, YouTubeDownloader};
...
fn test_download_single_video() {
    ...
    let temp_dir = std::env::temp_dir().join("mp3youtube_test");
    ...
    let result = downloader.download_playlist(
        &mp3youtube_core::PlaylistInfo {
            id: "test".to_string(),
            title: "Test Playlist".to_string(),
            video_count: 1,
            videos: vec![mp3youtube_core::VideoInfo {
